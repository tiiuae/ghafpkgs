...
constexpr const gchar* DBUS_INTERFACE_OBJECT_MANAGER = "org.freedesktop.DBus.ObjectManager";
...
constexpr const gchar* DBUS_INTERFACE_INTROSPECTABLE = "org.freedesktop.DBus.Introspectable";
constexpr const gchar* DBUS_INTERFACE_PROPERTIES = "org.freedesktop.DBus.Properties";
constexpr const gchar* DBUS_INTERFACE_PEER = "org.freedesktop.DBus.Peer";

constexpr const gchar* DBUS_NETWORK_MANAGER_NAME = "org.freedesktop.NetworkManager";
...
constexpr const gchar* SNI_SIGNAL_ITEM_REGISTERED = "StatusNotifierItemRegistered";
constexpr const gchar* SNI_SIGNAL_ITEM_UNREGISTERED = "StatusNotifierItemUnregistered";
...
constexpr const gchar* DBUSMENU_PATH = "/com/canonical/dbusmenu";
