...
void on_signal_received_catchall(GDBusConnection* connection, const gchar* sender_name,
...
void on_interfaces_removed(GDBusConnection* connection, const gchar* sender_name,
                           const gchar* object_path, const gchar* interface_name,
                           const gchar* signal_name, GVariant* parameters, gpointer user_data);
...
void on_name_acquired_log(GDBusConnection* conn, const gchar* name,
                          gpointer user_data G_GNUC_UNUSED);
void on_name_lost_log(GDBusConnection* conn, const gchar* name, gpointer user_data G_GNUC_UNUSED);
