...
"""GPS WebSocket server main module."""
...
class GpsProcessState:
    """State management for GPS process and WebSocket connections."""
...
async def read_continuous_gps(data):
    """Read continuous GPS data from gpspipe."""
...
def main():
    """Main entry point for the GPS WebSocket server."""
