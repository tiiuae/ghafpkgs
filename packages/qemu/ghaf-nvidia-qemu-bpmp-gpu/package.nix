...
#
# GPU-VM variant of ghaf-nvidia-qemu-bpmp. Same QEMU 10.1.5 + BPMP bridge, plus two
...
# when one exists.
{ ghaf-nvidia-qemu-bpmp }:
ghaf-nvidia-qemu-bpmp.override {
  variantName = "-gpu";
  ...
  extraPatches = [
    ../ghaf-nvidia-qemu-bpmp/patches/0002-vfio-platform-mmio-base.patch
    ../ghaf-nvidia-qemu-bpmp/patches/0003-nop-predefined-dtb-memory.patch
  ];
}
